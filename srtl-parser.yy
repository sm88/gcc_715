...
Pattern 
    ...
    |   Concrete_Pattern {
        if (!driver.currentPattern->inError ()) {
            ...
            driver.currentPattern->createPattern ();
            //cout << driver.currentPattern->getPatName() << yyget_lineno() << endl;
            //driver.currentPattern->setLineStart(yylloc.begin.line);
            //driver.currentPattern->setLineEnd(yylloc.end.line);
            driver.addToConstructTally (driver.currentPattern->getPatType ());
...
Concrete_Pattern    :   CONCRETE Concrete_Pattern_Name_Qualifier Concrete_Rtl_Spec {
    ...
    | CONCRETE Concrete_Pattern_Name_List '.' REG_CONS '{' Concrete_Inst_Stmt_List '}' {
        ...
        driver.currentPattern->setLineStart(@1.begin.line);
        ...
        cp->addModeStmts (*$6);
        driver.addAllPatternsEntry(driver.currentPattern);
        //cerr << "XXX" << ((ConcretePattern*)driver.currentPattern)->getTree()->getChildren().size() << endl;
        delete $2;
        delete $6;
    }
    ;
...
Concrete_Pattern_Name_Qualifier_S :  Concrete_Pattern_Name_List '.' CONS {
        ...
        driver.currentPattern->setLineStart(@2.begin.line);
        delete $1;
    }
